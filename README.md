...
### Что делает оптимизированный скрипт IPv6:
- ✅ Отключает IPv6 в настройках LAN и WAN с проверкой ошибок
- ✅ Отключает DHCPv6 и Router Advertisement безопасно
- ✅ Удаляет делегирование и ULA префиксы с валидацией
- ✅ Останавливает службу odhcpd с отчетом о статусе
- ✅ Отключает IPv6 на системном уровне с множественными проверками
- ✅ Настраивает DNS для работы только с IPv4
- ✅ Делает настройки постоянными в sysctl.conf с резервным копированием
- ✅ Очищает IPv6 записи из resolv.conf безопасно
- ✅ Проверяет итоговый статус отключения IPv6
